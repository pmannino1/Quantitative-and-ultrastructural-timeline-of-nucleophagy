...
% to find spots only.
% use a differnt script to estimate spots shape, pixels, boundaries etc

% % UNDER CONSTRUCTION:
% different versioj to deal with the imge edges: instead of trimmin the
% image pad it with zeros...
% tryingb to expnad Brad's findIrregularSpots function onto 3D images
%
% Brad's findIrregularSpots with only image input modified: no cell mesh
% input, images epxected to be matlab 2D or 3D matrix.
%
...
%
%images     - changed to the image matrix
